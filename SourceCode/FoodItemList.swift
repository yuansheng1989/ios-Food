...
class FoodItemList: ListBaseCD, AddFoodItemDelegate {
    ...
    override func viewDidLoad() {
        ...
        //frc = m.ds_frcForEntityNamed("FoodItem", withPredicateFormat: nil, predicateObject: nil, sortDescriptors: [NSSortDescriptor(key: "name", ascending: true)], andSectionNameKeyPath: nil)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.detailTextLabel?.text = "Quantity is \(item.quantity) grams"
        
        // From Data to UIImage
        // Attempt to create a UIImage representation of the photoThumbnail
        if let temp = item.photoThumbnail {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        // Sample workflow segue code...
         ...
         if segue.identifier == "toFoodItemScene" {
